...
if(isset($_GET['delete_id']))
{
    ...
    if($delete)
    {
        echo "<script>
                ...
                window.location='page-list-unit.php';
              </script>";
        exit;
    }
    else
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    ...
                    <a href="page-add-unit.php" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Add Sub-Category</a>
                </div>
            </div>
...
SELECT * from unit where delete_flag='1' and user_id='$user_id'");
