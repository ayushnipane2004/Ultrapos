...
if(isset($_GET['delete_id']))
{
    ...
    if($delete)
    {
        echo "<script>
                ...
                window.location='page-list-brand.php';
              </script>";
        exit;
    }
    else
        ...
        <div class="row">
            <div class="col-lg-12">
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    ...
                    <a href="page-add-brand.php" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Add Brand</a>
                </div>
            </div>
            ...
            <div class="col-lg-12">
                ...
                <table class="data-table table mb-0 tbl-server-info">
                    <thead class="bg-white text-uppercase">
                        ...
                        <tr class="ligth ligth-data" style="text-align:center">
    ...
    <td>
        ...
        <div class="d-flex align-items-center list-action">
            ...
            <a class="badge badge-info mr-2"
               href="view-brand.php?id=<?php echo $row['id']; ?>">
                <i class="ri-eye-line mr-0"></i>
            </a>

            <a class="badge bg-success mr-2"
               href="edit-brand.php?id=<?php echo $row['id']; ?>">
