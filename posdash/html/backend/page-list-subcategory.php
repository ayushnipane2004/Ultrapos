...
if(isset($_GET['delete_id']))
{
    ...
    if($delete)
    {
        echo "<script>
                ...
                window.location='page-list-category.php';
              </script>";
        exit;
    }
    else
            ...
            <div class="col-lg-12">
                <div class="d-flex flex-wrap align-items-center justify-content-between mb-4">
                    <div>
                        ...
                        <p class="mb-0">Use Sub-category list as to describe your overall core business from the provided list. <br>
                        Click the name of the Sub-category where you want to add a list item. .</p>
                    </div>
                    <a href="page-add-subcategory.php" class="btn btn-primary add-list"><i class="las la-plus mr-3"></i>Add Sub-Category</a>
                </div>
            </div>
...
<tr style="text-align:center">
    ...
    <td>
        ...
        <div class="d-flex align-items-center">
            ...
            <img src="<?php echo $row['sub_category_image']; ?>"
    ...
    <!-- Sub Category Code -->
    <td>
        <?php echo $row['sub_category_code']; ?>
    </td>
    ...
    <td>
        ...
        <div class="d-flex align-items-center list-action">
            ...
            <a class="badge badge-info mr-2"
               href="view-sub-category.php?id=<?php echo $row['id']; ?>">
                <i class="ri-eye-line mr-0"></i>
            </a>

            <a class="badge bg-success mr-2"
               href="edit-sub-category.php?id=<?php echo $row['id']; ?>">
