        ...
        <div class="content-page">
            ...
            <h3><?php echo $row['customer_name']; ?></h3>
                ...
                <form method="post">
                            ...
                            <input type="text" name="customer_code" class="form-control" id="product_image"  value="<?php echo $row['customer_code']; ?>" readonly>
                ...
                id="product_image"  value="<?php echo $row['city']; ?>">
                ...
                id="product_image"  value="<?php echo $row['state']; ?>">
                ...
                id="product_image"  value="<?php echo $row['pincode']; ?>">
                ...
                id="product_image"  value="₹ <?php echo number_format($row['credit_limit'],2); ?>">
